...
def obtener_nombres_carpetas(ruta_carpeta):
    ...
    for item in os.listdir(ruta_carpeta):
        ...
        if os.path.isdir(item_path):
            nombres_carpetas.append(item)
    return nombres_carpetas

# Ejemplo de uso
ruta_carpeta = "../data/train/final_data"  # Reemplaza con la ruta de tu carpeta
proteinas_PUResNet = obtener_nombres_carpetas(ruta_carpeta)
print(nombres_carpetas)

# Falta pillar las proteinas de DeepSurf y mirar cuales no estan en ambas listas, si no hay pillar las 4 primeras y ya ? 
