...
# Crear dos arrays de ejemplo con la misma shape
proteins1 = np.random.rand(4, 16, 16, 16, 18)
proteins2 = np.random.rand(1, 16, 16, 16, 18)

# Concatenar a lo largo del primer eje
proteins_combined = np.concatenate((proteins1, proteins2), axis=0)

# Verificar la shape del resultado
print(proteins_combined.shape)  # Salida: (2226, 16, 16, 16, 18)
